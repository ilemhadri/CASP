...
/* Calcul des meilleures predictions
...
qu'on place en fin de tableau. De meme pour leurs indices variant entre 0 et 455
 */
...
Il recupere egalement les indices 0 <= i <= 455 correspondant a ces dix meilleures predictions 
...
int main (int argc, char* argv[]){
   ...
   if (taskid ==0){
      ...
      for (int i =0;i<10;++i){
         ...
         finalBestId[i] = s.substr(0,s.size()-11); //pour un affichage du fichier exact correspondant
